...
<div class="action  divaction">
	...
	<div class="pages">
	     <s:form action="searchBizClaimVoucherStatistics.action" name="queryForm">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <tr>
	        ...
	        <a href="getBizClaimVoucherStatisticsByMonth.action?condition.year=<s:property value="#claimVoucherStatistics.year"/>&condition.month=<s:property value="#claimVoucherStatistics.month"/>&condition.dept=<s:property value="#claimVoucherStatistics.sysDepartment.id"/>">
