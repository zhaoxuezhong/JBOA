...
<div class="action  divaction">
	...
	<div class="pages">
	     <s:form action="deptStatistics_findDeptYearStatisticsList.action" name="queryForm">
	       		...
	       		<s:textfield name="condition.startYear" id="startYear" cssClass="nwinput" value=""></s:textfield>
	       		<label for="end-time">结束年份</label>
	       		<s:textfield name="condition.endYear" id="endYear" cssClass="nwinput" value=""></s:textfield>
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="#session.compYear.list" id="claimVouyearStatistics" begin="0" status="s">
	      <tr>
	    ...
	    <%--     <td><s:property value="#claimVoucherStatistics.month"/>月</td> --%>
	        <td><s:property value="#claimVouyearStatistics.sysDepartment.name"/></td> 
	        <td>
	        ...
	        <a href="getBizClaimVouyearStatisticsByYear.action?condition.year=<s:property value="#claimVouyearStatistics.year"/>&dept=<s:property value="#claimVouyearStatistics.sysDepartment.id"/>">
	      ...
	      <tr>
	        <td colspan="6" align="center">
				...
				<c:param name="totalCount" value="${compYear.totalCount}"/>
				<c:param name="pageTotalCount" value="${compYear.pageTotalCount}"/>
				<c:param name="pageIndex" value="${compYear.pageIndex}"/>
  			</c:import> 
  			</td>
	      </tr>
	    </table>        
