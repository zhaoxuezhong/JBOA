...
<div class="action  divaction">
	...
	<div class="pages">
		<s:form action="compYearStatistics_getDetailExcel.action" name="queryForm">
		        ...
		        <input type="button" class="submit_01" onclick="exportExcel(<s:property value="condition.year" />)" value="导出报表" />
	     </s:form>
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="#session.compYear.list" id="deptClaimVoucher" begin="0" status="s">
	      <tr>
