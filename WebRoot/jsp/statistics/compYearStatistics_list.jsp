...
<div class="action  divaction">
	...
	<div class="pages">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="#session.compYear.list" id="claimVoucherStatistics" begin="0" status="s">
	      <tr>
	        ...
	        <%-- <td><s:property value="#claimVoucherStatistics.sysDepartment.name"/></td> --%>
	        <td>
	        ...
	        <a href="searchBizClaimVouyearStatistics.action?condition.year=<s:property value="#claimVoucherStatistics.year"/>">
