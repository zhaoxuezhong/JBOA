...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="action  divaction">
		<div class="t">发送信息</div>
		<div class="pages">
			<s:form action="saveBizClaimVoucher.action" name="claimForm">
				...
				<table>
					...
					<tr align="center" colspan="4">
						...
						<input type="button" id="1" name="1" value="保存" onclick="submitClaimVoucher('保存')" class="submit_01"/>
							<input type="button" id="2" name="2" value="发送" class="submit_01"
								onclick="submitClaimVoucher('发送')" />
						</td>
					</tr>
				</table>
				</s:form>
